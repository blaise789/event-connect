    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
            ...
            <div className='col-span-2'>
                ...
                <a href="https://www.facebook.com/kirengaremyclaudien/" className='p-4 bg-[#E9F8F3] rounded-xl  hover:bg-[#91d6a9]'><FaFacebookF size={25} style={{color:'#4DC39E'}} /></a>
                        <a href="https://dribbble.com/byumvuhoreaimable" className='p-4 bg-[#E9F8F3] rounded-xl hover:bg-[#91d6a9]'><FaDribbble size={25} style={{color:'#4DC39E'}} /></a>
                        <a href="https://www.linkedin.com/in/jeremy-nk-413a612a6/" className='p-4 bg-[#E9F8F3] rounded-xl hover:bg-[#91d6a9]'><FaLinkedinIn size={25} style={{color:'#4DC39E'}} /></a>
                        <a href="www.instagram.com" className='p-4 bg-[#E9F8F3] rounded-xl hover:bg-[#91d6a9]'><FaInstagram size={25} style={{color:'#4DC39E'}} /></a>
                        <a href="https://www.youtube.com/@BAI-SHOWS" className='p-4 bg-[#E9F8F3] rounded-xl hover:bg-[#91d6a9]'><FaYoutube size={25} style={{color:'#4DC39E'}} /></a>
           ...
           <footer className="bg-slate-100 text-gray-600 text-center w-full mt-20">
